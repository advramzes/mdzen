...
<!-- For checkpoint task examples and patterns, see @F:/MDZen/.claude/get-shit-done/references/checkpoints.md -->
...
See `F:/MDZen/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `F:/MDZen/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `F:/MDZen/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
