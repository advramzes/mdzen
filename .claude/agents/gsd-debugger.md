...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = F:/MDZen/.claude
                  → checks F:/MDZen/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = F:/MDZen/.claude/get-shit-done
                  → writes to F:/MDZen/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "F:/MDZen/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "F:/MDZen/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "F:/MDZen/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
